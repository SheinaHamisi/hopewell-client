...
function Update() {
  return (
    <form className="h-screen w-screen relative overflow-hidden bg-gray-200">
      <section className=" absolute top-6 right-6 bottom-6 left-0 grid grid-cols-2 bg-gray-200  overflow-hidden">
        <img
          src="update.svg"
          className=" object-cover w-full h-full hidden xl:block "
          alt=""
        />
        <div className=" bg-white shadow-lg w-full h-full px-32 py-3 overflow-x-scroll flex flex-col justify-center items-center">
          <div>
          ...
          <div className="grid grid-cols-1 w-full py-12 space-y-7">
            <Input
              label="Password"
              type="password"
